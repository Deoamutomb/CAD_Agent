...
server.resource(
  "stl-model-list",
  new ResourceTemplate("stl-model-list:/", { list: undefined }),
  async (uri) => {
...
server.resource(
  "stl-model",
  new ResourceTemplate("stl-model://{model_id}", { list: undefined }),
  async (uri) => {
...
server.resource(
  "stl-model-metadata",
  new ResourceTemplate("stl-model-metadata://{model_id}", { list: undefined }),
  async (uri) => {
    const modelId = uri.pathname.split('/').pop() || '';
...
server.tool(
  "analyze_stl",
  { model_id: z.string().describe("ID of the STL model to analyze") },
  async ({ model_id }) => {
